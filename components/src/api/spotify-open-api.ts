...
export interface components {
  schemas: {
    ...
    RecommendationsObject: {
      /** @description An array of [recommendation seed objects](/documentation/web-api/reference/#object-recommendationseedobject). */
      seeds: (components["schemas"]["RecommendationSeedObject"])[];
      /** @description An array of [track object (simplified)](/documentation/web-api/reference/#object-simplifiedtrackobject) ordered according to the parameters supplied. */
      tracks: (components["schemas"]["SimplifiedTrackObject"])[];
    };
    ...
    PlaylistObject: {
      ...
      tracks?: components["schemas"]["PagingObject"];
    ...
    TrackObject: {
      ...
      linked_from?: components["schemas"]["TrackObject"];
      /**
       * @description Included in the response when a content restriction is applied.
       * See [Restriction Object](/documentation/web-api/reference/#object-trackrestrictionobject) for more details.
       */
    ...
    ShowObject: components["schemas"]["ShowBase"] & {
      ...
      episodes: components["schemas"]["PagingObject"];
    };
    ...
    AudiobookObject: components["schemas"]["AudiobookBase"] & {
      ...
      chapters: components["schemas"]["PagingObject"];
    };
  ...
  responses: {
    ...
    PagedAlbums: {
      content: {
        "application/json": {
          albums: components["schemas"]["PagingObject"];
        };
      };
    };
    ...
    SearchItems: {
      content: {
        "application/json": {
          tracks?: components["schemas"]["PagingObject"];
          artists?: components["schemas"]["PagingObject"];
          albums?: components["schemas"]["PagingObject"];
          playlists?: components["schemas"]["PagingObject"];
          shows?: components["schemas"]["PagingObject"];
          episodes?: components["schemas"]["PagingObject"];
          audiobooks?: components["schemas"]["PagingObject"];
        };
      };
    };
...
export interface operations {
  ...
  "get-an-albums-tracks": {
     ...
     */
    responses: {
      200: components["responses"]["PagingObject"];
      401: components["responses"]["Unauthorized"];
      403: components["responses"]["Forbidden"];
      429: components["responses"]["TooManyRequests"];
    };
  ...
  "get-recently-played": {
    ...
    responses: {
      200: components["responses"]["CursorPaging"];
      401: components["responses"]["Unauthorized"];
      403: components["responses"]["Forbidden"];
      429: components["responses"]["TooManyRequests"];
    };
